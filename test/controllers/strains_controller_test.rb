...
class StrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create strain' do
    assert_difference('Strain.count') do
      post strains_url,
           params: { strain: { aroma: @strain.aroma, cbd_level: @strain.cbd_level, description: @strain.description,
                               flovering_period: @strain.flovering_period, genotype: @strain.genotype, name: @strain.name, terpenes: @strain.terpenes, thc_level: @strain.thc_level } }
    end
