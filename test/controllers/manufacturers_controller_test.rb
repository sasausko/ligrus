...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference("Manufacturer.count") do
      post manufacturers_url, params: { manufacturer: { description: @manufacturer.description, local: @manufacturer.local, name: @manufacturer.name } }
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { description: @manufacturer.description, local: @manufacturer.local, name: @manufacturer.name } }
